...
void RGBWidget::paintGL()
{
	...
	vector<Vec3d> video = data->GetImage();
	...
	vector<Vec3d> vertices = data->GetPalette();
	...
	vector<std::array<uint,3>> faces=data->GetFaces();
	int const fcnt = faces.size();
	...
	for (int i = 0; i < fcnt; i++)
	{
		...
		Vec3d p = vertices[vid1];
		Vec3d q = vertices[vid2];
		Vec3d r = vertices[vid3];
